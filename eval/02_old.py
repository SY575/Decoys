...
# =============================================================================
    ...
    output_name = output_loc + \
        f'/{target}_selected_{num_dec_per_act}_{num_cand_dec_per_act}.smi'
...
# =============================================================================
    ...
    with open(output_loc+f'/{target}_results.csv', 'a') as csvfile:
        ...
        output_name = f'/{target}_selected_{num_dec_per_act}_{num_cand_dec_per_act}_output.smi'
        run(f'./eval/results/{target}_selected_{num_dec_per_act}_{num_cand_dec_per_act}.smi', 
